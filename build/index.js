...
var EditInPlace = function (_Component) {
    _inherits(EditInPlace, _Component);
    ...
    function EditInPlace() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = EditInPlace.__proto__ || Object.getPrototypeOf(EditInPlace)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
            ...
            if (!_this.state.editable) {
                ...
                switch (type) {
                    case "textarea":
                        return _react2.default.createElement('textarea', fieldProps);
                    case "select":
                        return _react2.default.createElement(
                            'select',
                            fieldProps,
                    ...
                    default:
                        // HTML5 Inputs
                        return _react2.default.createElement('input', _extends({ type: type }, fieldProps));
                }
            }
        }, _this.onEditEnable = function () {
            _this.setState({ editable: true });
        }, _this._onFinishEditing = function (e) {
    ...
    _createClass(EditInPlace, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                'div',
                { className: '_edit__in__place__container_' },
...
EditInPlace.propTypes = {
    ...
    dropDownOptions: _propTypes2.default.array
};
